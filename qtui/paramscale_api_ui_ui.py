/********************************************************************************
** Form generated from reading UI file 'paramscale_api_ui.ui'
**
...
#ifndef PARAMSCALE_API_UI_UI_H
#define PARAMSCALE_API_UI_UI_H
...
public:
    ...
    void setupUi(QWidget *paramscale)
    {
        ...
        gridLayout_3->addWidget(derivatives, 9, 0, 1, 1);
    ...
    void retranslateUi(QWidget *paramscale)
    {
        ...
        derivatives->setText(QCoreApplication::translate("paramscale", "Build all morphometric parameters", nullptr));
