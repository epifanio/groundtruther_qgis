...
class GeoMorphonDialog(QDialog, GeoMorphon):
    """docstring"""
    ...
    def exec_geomorphon(self):
        ...
        self.parent.gis_tool_report.setHtml(str('... running ...'))
        self.worker = Worker(self.run_grassapi, headers, params)
        self.worker.signal.module_output.connect(self.show_module_output)
    ...
    def show_module_output(self, module_output):
        ...
        self.parent.gis_tool_report.setHtml(str(module_output))
        ...
        #self.parent.gis_tool_report.setHtml(str(self.returned_item))
